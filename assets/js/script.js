    ...
    var SaaSio = {
        ...
        Basic: {
            ...
            EiStickyMenu: function() {
                jQuery(window).on("scroll", function() {
                    if (jQuery(window).scrollTop() > 100) {
                        jQuery(".main-header-eight").addClass(
                ...
                $(".appi-ei-open_mobile_menu").on("click", function() {
                    $(".appi-ei-mobile_menu_wrap").toggleClass(
                        "mobile_menu_on"
                    );
                });
                $(".appi-ei-open_mobile_menu").on("click", function() {
                ...
                if ($(".ei-appScreenshotCarousel-container").length) {
                    if ($(".ei-appScreenshotCarousel-container").length) {
                        var swiper = new Swiper(
                            ".ei-appScreenshotCarousel-container", {
                                effect: "coverflow",
                                loop: true,
                                centeredSlides: true,
                                slidesPerView: 4,
            ...
            APPSeoHeader: function() {
                jQuery(window).on("scroll", function() {
                    if (jQuery(window).scrollTop() > 100) {
                        jQuery(".appseo-main-header").addClass(
                            "appseo-sticky-header-overlay"
                        );
                    } else {
                        jQuery(".appseo-main-header").removeClass(
                            "appseo-sticky-header-overlay"
                        );
                    }
                });
            ...
            AppSeoMobileMenu: function() {
                ...
                if ($(".appseo-mobile_menu li.dropdown ul").length) {
                    $(".appseo-mobile_menu li.dropdown").append(
                        '<div class="dropdown-btn"><span class="fa fa-angle-down"></span></div>'
                    );
                    $(".appseo-mobile_menu li.dropdown .dropdown-btn").on(
                        "click",
                        function() {
                            $(this).prev("ul").slideToggle(500);
                        }
            ...
            SaaSMMobileMenu: function() {
                ...
                $(document).on(
                    "click",
                    ".mobile_menu_wrap ul li.dropdown > a",
                    function(event) {
                        $(this)
                            .parent()
                            .find(".dropdown-menu")
            ...
            SaaSCMobileMenu: function() {
                ...
                if ($(".s2-mobile_menu li.dropdown ul").length) {
                    $(".s2-mobile_menu li.dropdown").append(
                        '<div class="dropdown-btn"><span class="fa fa-angle-down"></span></div>'
                    );
                    $(".s2-mobile_menu li.dropdown .dropdown-btn").on(
                        "click",
                        function() {
                            $(this).prev("ul").slideToggle(500);
                        }
            ...
            SaaSCOnePageNav: function() {
                jQuery(window).on("scroll", function() {
                    if (jQuery(window).scrollTop() > 100) {
                        jQuery(".saas_two_main_header").addClass(
                            "saas_2-menu-bg-overlay "
                        );
                    } else {
                        jQuery(".saas_two_main_header").removeClass(
                            "saas_2-menu-bg-overlay "
                        );
                    }
                });
            ...
            StrMobileMenu: function() {
                ...
                if ($(".str-mobile_menu li.dropdown ul").length) {
                    $(".str-mobile_menu li.dropdown").append(
                        '<div class="dropdown-btn"><span class="fa fa-angle-down"></span></div>'
                    );
                    $(".str-mobile_menu li.dropdown .dropdown-btn").on(
                        "click",
                        function() {
                            $(this).prev("ul").slideToggle(500);
                        }
            ...
            StrOnePageNav: function() {
                jQuery(window).on("scroll", function() {
                    if (jQuery(window).scrollTop() > 100) {
                        ...
                        jQuery(".str-main-header").removeClass(
                            "str-sticky-menu"
                        );
                    }
                });
            ...
            StrTestimonial: function() {
                $("ol.carousel-indicators2 li").on("click", function() {
                    $("ol.carousel-indicators2 li.active").removeClass(
                        "active"
                    );
            ...
            DiaHeader: function() {
                jQuery(window).on("scroll", function() {
                    if (jQuery(window).scrollTop() > 100) {
                        ...
                        jQuery(".dia-main-header").removeClass(
                            "dia-sticky-menu"
                        );
                    }
                });
            ...
            PmMobileMenu: function() {
                ...
                if ($(".pm-mobile_menu li.dropdown ul").length) {
                    $(".pm-mobile_menu li.dropdown").append(
                        '<div class="dropdown-btn"><span class="fa fa-angle-down"></span></div>'
                    );
                    $(".pm-mobile_menu li.dropdown .dropdown-btn").on(
                        "click",
                        function() {
                            $(this).prev("ul").slideToggle(500);
                        }
